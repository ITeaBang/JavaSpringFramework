...
public class Main {
	...
	public static void main(String[] args) {
		...
		/*
		 * List<MyUserVO> list = dao.userlist(); for (MyUserVO vo : list) {
		 * System.out.println(vo); }
		 */

		/*
		 * // id를 가지고 데이터를 조회하는 메소드 호출 MyUserVO vo = dao.selectuser("irin");
		 * System.out.println(vo);
		 * 
		 * vo = dao.selectuser("suzi"); System.out.println(vo);
		 */

		Scanner sc = new Scanner(System.in);
		// primary key의 값을 입력받을 때에는 반드시 중복 체크를 해야 합니다.
		String id = "";
		while (true) {
